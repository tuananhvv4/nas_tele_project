...
<div class="space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Thêm danh mục</h1>
    </div>
        ...
        <div class="card-body">
            <form method="POST" action="/admin/categories">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent_id" class="form-select">
                            ...
                            <option value="<?= $p['id'] ?>" <?= \Core\View::old('parent_id') == $p['id'] ? 'selected' : '' ?>><?= htmlspecialchars($p['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-textarea" rows="3"><?= htmlspecialchars(\Core\View::old('description')) ?></textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                    <div class="form-group">
                        <label class="form-label">Thứ tự sắp xếp</label>
                        <input type="number" name="sort_order" class="form-input" value="<?= \Core\View::old('sort_order', '0') ?>">
                    </div>
